...
Aplicación Java con patrón MVC y conexión a bases de datos SQL. Dedicada a la gestión de clientes, empleados y proyectos. Introduce clientes y empleados para después poder asignarlos a proyectos.

...
public class VistaDisenadores extends JFrame {
	...
	public VistaDisenadores() {
		setTitle("Vista empleados > Dise\u00F1adores");
		iniciarComponentes();
		iniciarManejadores();
	...
	private void iniciarComponentes() {
       ...
       String[]columnNames = {
       		"ID", "NOMBRE", "DNI", "EMAIL", "TELEFONO", "SALARIO", "UBICACIÓN"
       	};
       ...
       JLabel lblClientesRegistrados = new JLabel("Diseñadores Contratados:");

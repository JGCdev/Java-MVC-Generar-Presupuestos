...
public class VistaEmpleados extends JFrame {
	...
	private JButton btnVerProgramadores;
	private JButton btnVerDiseadores;
	...
	private void iniciarManejadores() {
		 ...
		 btnNuevo.addActionListener(new ActionListener() {
		       	public void actionPerformed(ActionEvent e) {
		       		setVisible(false);
		       		AnadirEmpleadoTipo frame = new AnadirEmpleadoTipo();
					frame.setVisible(true);
		       	}
		 });
		 ...
		 btnVerDiseadores.addActionListener(new ActionListener() {
		       	public void actionPerformed(ActionEvent e) {
		       		setVisible(false);
		       		VistaDisenadores frame = new VistaDisenadores();
		       		frame.setVisible(true);
		       	}
		 });
		 btnVerProgramadores.addActionListener(new ActionListener() {
		       	public void actionPerformed(ActionEvent e) {
		       		setVisible(false);
		       		VistaProgramadores frame = new VistaProgramadores();
		       		frame.setVisible(true);
		       	}
		 });
	...
	private void iniciarComponentes() {
       ...
       JLabel lblClientesRegistrados = new JLabel("Empleados Registrados:");
       ...
       btnVerProgramadores = new JButton("Ver programadores");
       
       btnVerProgramadores.setBounds(266, 299, 169, 23);
       contentPane.add(btnVerProgramadores);
       
       btnVerDiseadores = new JButton("Ver dise\u00F1adores");
       
       btnVerDiseadores.setBounds(445, 299, 173, 23);
       contentPane.add(btnVerDiseadores);
